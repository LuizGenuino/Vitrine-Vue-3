    ...
    <v-card class="surface-soft pa-4 pa-md-5" rounded="xl">
        ...
        <v-card class="overflow-hidden" rounded="xl">
                ...
                <div class="pa-5 pa-md-8" :style="{
                    ...
                    <div class="d-flex align-center ga-4">
                        ...
                        <div class="text-white">
                            ...
                            <div class="text-body-2" style="opacity: 0.84">{{ props.settings.title ||
                                'Título principal da sua loja' }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="pa-5 pa-md-6">
                <div class="text-body-1 font-weight-medium mb-4">{{ props.settings.subtitle ||
                    'Subtítulo com proposta de valor clara.' }}</div>
                <v-row>
