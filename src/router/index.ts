  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 's/:storeSlug', name: 'storefront', component: () => import('@/pages/public/StorefrontPage.vue') },
        {
          path: 's/:storeSlug/produto/:productSlug',
          name: 'product',
          component: () => import('@/pages/public/ProductPage.vue'),
        },
        { path: 's/:storeSlug/carrinho', name: 'cart', component: () => import('@/pages/public/CartPage.vue') },
      ],
    },
    {
      path: '/auth',
