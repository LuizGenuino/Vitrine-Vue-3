    ...
    <v-navigation-drawer v-model="drawer" width="280" class="pa-3">
      ...
      <v-card class="glass-panel pa-4 mb-4" rounded="xl">
        ...
        <div class="d-flex align-center justify-space-between ga-3">
          <div>
            ...
            <div class="text-body-2 text-medium-emphasis">Até {{ planService.getLimitLabel(activePlan.productLimit) }} produtos</div>
          </div>
      ...
      <template #append>
        <div class="pa-3 d-flex flex-column ga-3">
          <v-btn v-if="publicUrl" block variant="outlined" :href="publicUrl" target="_blank">Ver vitrine</v-btn>
